        ...
        <div class="container">
            <div class="cart_inner">
                <div class="table-responsive">
                    <?php if(!empty(isset($_SESSION['cart']))): ?>
                    <table class="table">
                        <thead>
                            <tr>
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="product_count">
                                        <input type="text" name="qty" id="sst" maxlength="12" value="<?php echo escape($qty); ?>" title="Quantity:"
                                            class="input-text qty" readonly style="border:0px;">
                                    </div>
                                </td>
                                <td>
                                ...
                                <td>
                                    <a style="line-height:30px;border-radius:10px;" href="cart_item_clear.php?pid=<?php echo escape($result->id);?>" class="primary-btn">Clear</a>
                                </td>
                            </tr>
