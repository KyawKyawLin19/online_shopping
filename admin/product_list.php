            ...
            <div class="card">
              ...
              <?php 
                ...
                if(empty($_POST['search']) && empty($_COOKIE['search'])){
                  ...
                  $stmt = $pdo->prepare("SELECT * FROM products WHERE name LIKE '%$search%' ORDER BY id DESC LIMIT $offset,$numOfrecs");
              ...
              <div class="card-body">
                <div>
                  <a href="product_add.php" class="btn btn-primary" type="button">New Product</a>
                </div>
                <br>
                <table class="table table-bordered">
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td><?php echo escape(substr($product->description,0,50)); ?></td>
                      <?php
                        $stmt = $pdo->prepare("SELECT * FROM categories WHERE id=".$product->category_id);

                        $stmt->execute();

                        $pcategory = $stmt->fetchAll(PDO::FETCH_OBJ); 
                      ?>
                      <td><?php echo $pcategory[0]->name ?></td>
                      <td><?php echo $product->quantity ?></td>
                      <td><?php echo $product->price ?></td>
                      <td>
                        <div class="btn-group">
                          <div class="container">
                            <a href="product_edit.php?id=<?php echo $product->id;?>" class="btn btn-warning" type="button">Edit</a>
                          </div>
                          <div class="container">
